...
{
       0,   576,   576,   577,   581,   582,   583,   587,   588,   589,
     590,   592,   591,   597,   596,   601,   605,   612,   613,   617,
     625,   626,   646,   650,   674,   677,   684,   688,   692,   696,
     704,   708,   737,   744,   752,   760,   767,   768,   771,   773,
     774,   775,   779,   780,   784,   789,   794,   801,   813,   820,
     821,   825,   836,   848,   852,   856,   860,   864,   868,   872,
     876,   880,   884,   888,   895,   918,   921,   928,   929,   932,
     933,   938,   941,   948,   952,   959,   963,   967,   971,   978,
     982,   989,   993,   997,  1004,  1011,  1015,  1022,  1026,  1033,
    1037,  1044,  1051,  1066,  1070,  1078,  1082,  1092,  1095,  1103,
    1106,  1114,  1117,  1125,  1128,  1134,  1134,  1135,  1135,  1136,
    1136,  1137,  1137,  1138,  1138,  1139,  1139
};
#endif
...
#line 618 "ppparse.y"
    {
	cb_define_struct * p = ppp_define_add(ppp_setvar_list, (yyvsp[(2) - (4)].s), (yyvsp[(4) - (4)].s), 1);
	if(p) {
		ppp_setvar_list = p;
...
#line 709 "ppparse.y"
	...
	if(q) {
		cb_define_struct * p = ppp_define_add(ppp_setvar_list, (yyvsp[(1) - (4)].s), q, (yyvsp[(4) - (4)].ui));
		if(p) {
			ppp_setvar_list = p;
		}
	}
...
#line 738 "ppparse.y"
    {
	cb_define_struct * p = ppp_define_add(ppp_setvar_list, (yyvsp[(1) - (4)].s), (yyvsp[(3) - (4)].s), (yyvsp[(4) - (4)].ui));
	if(p) {
		ppp_setvar_list = p;
	}
  }
...
#line 745 "ppparse.y"
    {
	cb_define_struct * p = ppp_define_add(ppp_setvar_list, (yyvsp[(2) - (5)].s), (yyvsp[(4) - (5)].s), (yyvsp[(5) - (5)].ui));
	if(p) {
		ppp_setvar_list = p;
...
#line 785 "ppparse.y"
    {
	unsigned int found = (ppp_search_lists((yyvsp[(1) - (4)].s)) != NULL);
...
#line 790 "ppparse.y"
    {
	unsigned int found = ppp_search_comp_vars((yyvsp[(1) - (4)].s));
	plex_action_directive(current_cmd, found ^ (yyvsp[(3) - (4)].ui));
  }
    break;
...
#line 795 "ppparse.y"
	...
	cb_define_struct * p = ppp_search_lists((yyvsp[(1) - (5)].s));
...
#line 837 "ppparse.y"
    {
	cb_define_struct * p = ppp_search_lists((yyvsp[(1) - (1)].s));
