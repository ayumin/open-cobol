...
#else  // no MAKE_DIST
#define COB_MAIN_DIR     "C:\\Users\\simon\\Documents\\gnu-cobol-cpp"
...
#ifdef _DEBUG
#define COB_BLD_CFLAGS   "/Zi /Od /Oy- /Gm /EHsc /RTC1 /MDd /GS /fp:precise /Zc:wchar_t /Zc:forScope /Gd"
#else
#define COB_BLD_CFLAGS   "/O2 /Ob2 /Oi /Ot /Oy- /GL /Gm- /EHsc /MD /GS /fp:precise /Zc:wchar_t /Zc:forScope /Gd"
#endif
